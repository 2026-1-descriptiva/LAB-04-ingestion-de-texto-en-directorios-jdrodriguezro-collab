...
def pregunta_01():
    ...
    # Descomprimir input.zip en la carpeta files
    ...
    def crear_dataset(tipo):
        ...
        for sentimiento in ["negative", "neutral", "positive"]:
            carpeta = os.path.join("files", "input", tipo, sentimiento)
    ...
    train_dataset = crear_dataset("train")
    test_dataset = crear_dataset("test")
